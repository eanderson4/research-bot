...
|--------|--------------|-------------------|
| 0.26 mL per median Gemini text prompt ("about five drops of water") | [SCOPE-1 on-site cooling] [CONSUMPTIVE] [PER-QUERY] [SINGLE-SOURCE – Google’s own estimate, not peer-reviewed] | Google study, reported by The Verge |
...
| Google omits indirect water use (scope‑2 electricity‑generation water). "A majority of the water a data center consumes stems from its electricity use." | [SCOPE-2 electricity-generation water] – explicitly excluded by Google | The Verge (article narrative) |
| "You only see the tip of the iceberg" – de Vries-Gao’s characterization of Google’s 0.26 mL. | – | Alex de Vries-Gao quote |
...
| Google claims **33× reduction** in electricity per prompt between May 2024 and May 2025 | 2024–2025 improvement | Google blog (cited in article) |
...
- Google acknowledges that overall carbon emissions grew **11% last year** and **51% since 2019** (from its sustainability report). Google also began excluding certain categories of GHG emissions from its climate goals.
- Efficiency gains can still lead to more total resource use (Jevons paradox) – noted in the article.
